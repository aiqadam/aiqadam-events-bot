...
| [0027](0027-prototype-as-target-reference.md) | Прототип — целевой эталон (to-be), а не снимок текущего (уточняет 0026, сужает формулировку W41) | **Черновик** (на принятие владельцем) |
