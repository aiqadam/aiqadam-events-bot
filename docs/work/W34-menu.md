...
|----------|----------|---------|
| flow `menu` | `—` | [catalog/flows/menu.md](../../catalog/flows/menu.md) |
| flow `tg-router` (новая ветка) | `nyaBzgKGG8TTTsryjc9tW` | [catalog/flows/tg-router.md](../../catalog/flows/tg-router.md) |
...
- [ ] гость без ивентов — 2 кнопки, owner — 3 (`+ Создать ивент`, `web_app #/manage`), staff — 3 (`+ Сканер`, `web_app #/scan?event_id=<ближайший будущий>`; без будущих ивентов — 2) — 4 прогона с фикстурами `events`/`event_staff`
