...
> ## Куда идти дальше (2026-09-14, после пересмотра беклога)
>
> Фундамент собран и принят; W28 (пилот ADR-0017), W33 (SPA) и W34 (меню)
> закрыты. Порядок при одном агенте: **W35** (дозапись `migrations`, хэш
> W34 есть) → **W32** (allow-list `owners`, `initData` 5 минут — без него
> создать ивент вправе любой пользователь бота; нужен `telegram_id` владельца
> для `owners`) → **[W13](BACKLOG.md#w13-список-участников-и-экспорт)** (списки
> и экспорт) → W14 (начинается с замера [Q13](OPEN-QUESTIONS.md#q13) и
> решения [Q18](OPEN-QUESTIONS.md#q18)) → W15. Между звеньями или вторым
> агентом свободны W10, W12, W12b. Порядок и параллельность —
> [ROADMAP.md](ROADMAP.md#критический-путь).
>
...
Критический путь на 2026-09-14: **`W35 → W32 → W13 → W14 → W15`** — W28,
W33, W34 пройдены (обоснование порядка — [ROADMAP.md](ROADMAP.md#критический-путь)).
W10, W12, W12b в него не входят — нужны продукту, но приёмку не держат.
Полная картина порядка и параллельности — [ROADMAP.md](ROADMAP.md).

Решения владельца 2026-09-14 ([Q41](OPEN-QUESTIONS.md#q41)–[Q47](OPEN-QUESTIONS.md#q47),
[ADR-0022](adr/0022-miniapp-react-spa.md)): W9 не будет сделан; W12b сужен до
диагностики и свободен; визард ивента переезжает в Mini App — пакет W31 сдан
