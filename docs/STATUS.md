...
| W42. Визард ивента: шаги и гео ссылкой Яндекс.Карт (вердикт W41; Q52 закрыт — без карты) | v0.1 | W33 — ✅, W37 — ✅; Q52 — ✅ | **на проверке** 2026-09-16 — вердикт владельца по прототипу ([ADR-0027](adr/0027-prototype-as-target-reference.md)): сняты самовольные отступления (иконки, экран успеха, шиты ссылки/отмены, тост, гео-превью), каждое оставшееся отличие названо в [журнале](work/W42-event-wizard.md#сверка-с-прототипом-вердикт-владельца-2026-09-16) с причиной; `manage-api` не менялся; прогоны 49/49 и 23/23. Прежние вердикты (круги 1–3, дизайн-цикл 7→9) обнулены правками — идёт круг 4 | агент | [W42](work/W42-event-wizard.md) |
