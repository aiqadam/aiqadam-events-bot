...
| W5. Регистрация | 4 | W4 | на проверке | агент W5 | [W05](work/W05-registration.md) |
...
криптографией (не моками) и прямым `curl` на публичный эндпоинт. Пакету
поставлен статус `на проверке` — чек-лист закрыт полностью, не хватает только
независимого ревью. Живое состояние —
