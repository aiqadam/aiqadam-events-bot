...
| W18. Страховка от fail-open дефектов платформы ([Q25](OPEN-QUESTIONS.md#q25), qadam-flow#382/#392) | 5 | W8, W16 | **на проверке** с 2026-09-13 | агент W18 | [W18](work/W18-fail-open-mitigation.md) |
...
вхождения** во всех пяти флоу, ключи не ротировались. Попутно выяснено, что
...
- **Открытые вопросы.** Полный список и статусы — [OPEN-QUESTIONS.md](OPEN-QUESTIONS.md)
  ...
  `{{VAR}}` по всем пяти флоу не нашёл ни одного вхождения.
