...
> ## Куда идти дальше (2026-09-13)
>
> Фундамент собран и принят. Следующий пакет по критическому пути —
> **[W28](BACKLOG.md#w28-пилот-adr-0017--гостевой-срез-одной-карточкой)**
> (пилот ADR-0017). Порядок и параллельность — [ROADMAP.md](ROADMAP.md),
> он переписан в тот же день: прежние «волны 1–6» описывали состав,
...
| W29. Экспорт `flows/*.json` ([ADR-0018](adr/0018-rest-read-for-everyone.md) п. 3) | — | ключ API у человека (шаг 0.7) | **заблокирован** 2026-09-13 — нет доступа к ключу платформы; инструмент, чек-листы и чистка каталога сделаны | агент W29 | [W29](work/W29-flows-export.md) |
...
W30 в него не входят — нужны продукту, но приёмку не держат.
Полная картина порядка и параллельности — [ROADMAP.md](ROADMAP.md).

Не берутся до решения владельца: **W9** ([Q41](OPEN-QUESTIONS.md#q41)),
**W12b** ([Q42](OPEN-QUESTIONS.md#q42)). Визард ивента не трогает никто
до ответа на [Q43](OPEN-QUESTIONS.md#q43).
...
- **Открытые вопросы.** Источник правды — [OPEN-QUESTIONS.md](OPEN-QUESTIONS.md),
  ...
  [Q40](OPEN-QUESTIONS.md#q40) (брендовый CSS — W30),
  [Q39](OPEN-QUESTIONS.md#q39) (нормализация экспорта — W29),
  [Q31](OPEN-QUESTIONS.md#q31) и [Q14](OPEN-QUESTIONS.md#q14) (обязаны быть
  закрыты до приёмки W15). Ждут решения владельца, а не работы:
  [Q41](OPEN-QUESTIONS.md#q41) (нужен ли W9),
  [Q42](OPEN-QUESTIONS.md#q42) (нужен ли W12b),
  [Q43](OPEN-QUESTIONS.md#q43) (переезжает ли визард в Mini App).
