...
| W31. Страница `manage`: визард ивента в Mini App ([Q43](OPEN-QUESTIONS.md#q43), [ADR-0017](adr/0017-screen-not-message.md) п. 3) | 8 | W30, W28 | не начат — **свободен**; `event-wizard-*` живут до приёмки `manage` | — | — |
