...
> ## Куда идти дальше (2026-09-14, ADR-0022)
>
...
> [Q13](OPEN-QUESTIONS.md#q13)). Параллельно свободны **W35** (дозапись
> `migrations` за W33–W34 — после W34), **W32** (owner'ы по списку, `initData`
> 5 минут), W10, W12, W12b. W34 (меню) — в работе; W33 (Mini App SPA,
> [ADR-0022](adr/0022-miniapp-react-spa.md)) закрыт. Порядок и параллельность —
...
| W34. Стартовое меню-хаб на холостой `/start` | вне волн | W28, W06, W33 | в работе — ретроактивная приёмка: флоу `menu` найден на инстансе при аудите, доводится по процессу | агент аудита | [W34](work/W34-menu.md) |
| W35. Дозапись `migrations` за W33–W34 ([ADR-0021](adr/0021-repo-is-source-of-truth-migrations-table.md)) | вне волн | W34 (хэш коммита для строк W34) | не начат — **свободен**; заведён 2026-09-14 по следам аудита W34: после `w31-14` в таблице нет ни строки (W33, `da810c0`, `91f20b0`, W34) | — | — |
| W15. Приёмка | 9 | все `готов` на момент приёмки | не начат | — | — |

Критический путь на 2026-09-14: **`W13 → W14 → W15`** — W28 пройден. W10,
W12, W12b, W33 в него не входят — нужны продукту, но приёмку не держат.
