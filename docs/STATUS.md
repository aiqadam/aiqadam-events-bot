...
| W32. Права `staff` по чаптеру, окна `initData` по флоу, афиша выведена временно ([ADR-0024](adr/0024-staff-by-chapter-event-staff-checkin.md), [Q46](OPEN-QUESTIONS.md#q46), [Q47](OPEN-QUESTIONS.md#q47), [Q49](OPEN-QUESTIONS.md#q49), [Q50](OPEN-QUESTIONS.md#q50)) | 3 | W33 — ✅ сдан | **на проверке (круг 2)** — замечание 1 исправлено и переопубликовано; живой различающий прогон закрыт (staff `200` / чужой чаптер `403` / не-staff `403` / просрочка `401`); ждёт вердикта повторного ревью | агент | [W32](work/W32-owners-initdata.md) |
