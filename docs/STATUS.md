...
> `migrations` за W33–W34), **W32** (owner'ы по списку, `initData`
> 5 минут), W10, W12, W12b. W34 (меню) и W33 (Mini App SPA,
> [ADR-0022](adr/0022-miniapp-react-spa.md)) закрыты. Порядок и параллельность —
