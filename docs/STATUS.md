...
| W32. Права `staff` по чаптеру, окна `initData` по флоу, афиша выведена временно ([ADR-0024](adr/0024-staff-by-chapter-event-staff-checkin.md), [Q46](OPEN-QUESTIONS.md#q46), [Q47](OPEN-QUESTIONS.md#q47), [Q49](OPEN-QUESTIONS.md#q49), [Q50](OPEN-QUESTIONS.md#q50)) | 3 | W33 — ✅ сдан | **в работе** — взял 2026-09-15; реализовано и опубликовано (staff/чаптер, `step_18`, окна, SPA); **блокер**: живые `curl`-прогоны ждут свежего `initData`, экспорт `flows/` — без REST-ключа | агент | [W32](work/W32-owners-initdata.md) |
