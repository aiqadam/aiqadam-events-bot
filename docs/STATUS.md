...
| W37. Полировка трёх путей v0.1 (замеры ADR-0009, ссылка-приглашение, список ивентов в `#/manage`) | v0.1 | W32, W36, W40 | не начат — **берётся после W40**; список `#/manage` возвращает вход в правку ивента, убранный вместе с `/editevent` | — | — |
