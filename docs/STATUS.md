...
| W31. Страница `manage`: визард ивента в Mini App ([Q43](OPEN-QUESTIONS.md#q43), [ADR-0017](adr/0017-screen-not-message.md) п. 3) | 8 | W30, W28 | **на проверке** 2026-09-14, круг 4 — форма и `manage-api` собраны, два круга замечаний закрыты; экспорт `flows/` снят через MCP ([ADR-0021](adr/0021-repo-is-source-of-truth-migrations-table.md)); фото — [Q46](OPEN-QUESTIONS.md#q46); `event-wizard-*` живут до вердикта | агент W31 | [W31](work/W31-manage-page.md) |
