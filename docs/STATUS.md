...
| W33. Mini App — React SPA: `ticket`/`scan`/`manage` ([ADR-0022](adr/0022-miniapp-react-spa.md)) | 8 | W30, W28 | **заблокирован** 2026-09-14 — `my-qr-api`/`checkin-api` `sync` виснет 30с в `PRODUCTION` `UNSANDBOXED` (платформа, [#440](https://github.com/aiqadam/qadam-flow/issues/440)), `SPA` `8854853` `index-D8VHs5ik.js` live, `ticket` `timeout 15000ms` | агент | [W33](work/W33-react-spa.md) |
