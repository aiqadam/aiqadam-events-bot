...
> **W15** (приёмка v0.1; сценарий «прерванная рассылка» не применим).
...
| W36. Staff-lite — права контролёра по `telegram_id` в `manage` SPA | v0.1 | W32 | **в работе** (взят 2026-09-15) | агент | [W36](work/W36-staff-lite-manage.md) |
| W37. Полировка трёх путей v0.1 (замеры ADR-0009, ссылка-приглашение, список ивентов в `#/manage`) | v0.1 | W32, W36, W40 | **в работе** (взят 2026-09-15): список ивентов и ссылка на экране построены, впереди живые прогоны и замеры | агент | [W37](work/W37-polish-three-paths.md) |
| W40. Убрать команды, кроме `/start` ([ADR-0025](adr/0025-start-only-commands-ban.md)) | v0.1 | W36 | **в работе** (взят 2026-09-15 — указание владельца «выпили сразу») | агент | [W40](work/W40-no-commands.md) |
...
Критический путь v0.1 на 2026-09-15: **`W35 → W32 → W36 → W40 → W37 → W15`** —
...
владельца; вход в правку ивента возвращает W37 списком `#/manage`. W13, W14,
