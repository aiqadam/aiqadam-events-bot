...
- **ревью не может проверить конфигурацию PIECE-шага** — только косвенно,
  по выводам прогонов. Владелец пакета обязан оставлять в журнале прогон,
  который различает верную и неверную конфигурацию;
