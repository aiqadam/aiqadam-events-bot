...
PROTO.protoDict = {
  ...
  'proto.menu_guest': 'Найдите свои билеты и регистрируйтесь на ивенты по кнопке ниже',
  'proto.menu_owner': 'Создайте ивент или откройте каталог по кнопкам ниже',
  'proto.menu_controller': 'Откройте каталог по кнопке ниже — сканер рядом с вашим ивентом',
  ...
  'onb.details': 'Что храним и зачем: имя, фамилия, должность, компания, город и telegram_id — чтобы вести список участников и пускать на ивенты. Храним у себя, третьим лицам не передаём, в продажу не пускаем. Согласие можно отозвать — напишите нам, данные удалим.',
  ...
  'onb.review': 'Проверьте: Дилшод Азимов · ML-инженер, Payme · Ташкент. Регистрация пока не создана — можно поправить.',
  'onb.suspect': 'В профиле Telegram — «Crypto King 👑»: такое в список участников не поставим. Напишите имя и фамилию руками.',
  'onb.second_hint': 'Профиль уже заполняли — регистрируем сразу, ничего не спрашиваем.',
