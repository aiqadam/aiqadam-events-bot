...
// Иконки — Lucide, inline-SVG: 2px stroke, currentColor (ADR-0019, прототип W41).
// Пути совпадают с prototypes/proto.js `PROTO.icons`; разметка — React-узлами,
// без innerHTML/dangerouslySetInnerHTML.
