...
> **Не встроен ни в один живой флоу с 2026-09-13.** Заменён эталоном
> [`ru-texts`](ru-texts.md) по [ADR-0014](../../docs/adr/0014-russian-only-until-platform-i18n.md)
> (только русский, пока нет платформенного i18n — qadam-flow#420, v2.0.0).
> Файл сохранён намеренно: он нужен при воскрешении i18n, и таблица «Встраивают»
> ниже описывает состояние **до** 2026-09-13. Разница с `ru-texts` — ровно один
> вход: `records` (записи `strings`) вместо `texts` (строки во входе шага).
