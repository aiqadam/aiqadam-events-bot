...
- **Назначение**: послесловие после чекина ([ADR-0017](../../docs/adr/0017-screen-not-message.md)
  ...
  Предложение зарегистрироваться на следующий ивент убрано вердиктом
  владельца (PAR-7) — единственное исходящее касание после ивента.
...
- **Проверено различающим прогоном** (W45): не был на ивенте → молчание;
  ...
  следующего ивента); повторный вызов на ту же пару `eventId`+`telegramId` →
