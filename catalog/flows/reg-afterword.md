...
- **Кто вызывает:** на момент написания — никто. Флоу ждёт
  [W12](../../docs/BACKLOG.md#w12-жизненный-цикл-и-напоминания), который
  повесит его на триггер `checked_in_at`. `checkin-api` пакетом W28
  **не менялся**.
