...
| step_4 | CODE «render menu» | сборка кнопок (W51): гость — 1 кнопка; организатор — [`Ивенты`, `Управление ивентами` → `#/manage`, `Создать ивент`]; контролёр — тот же 1 экран, свой текст; кнопки сканера в чате нет |
