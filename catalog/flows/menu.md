...
| step_4 | CODE «render menu» | сборка кнопок по вердикту W49 (W50): гость — 1 кнопка; организатор — +«Создать ивент»; контролёр — тот же 1 экран, свой текст; кнопки сканера в чате нет |
