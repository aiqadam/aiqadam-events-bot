...
- **Узкий нетроттленый цикл уведомления** — то же решение, что у
  `event-wizard-publish` ([Q36](../../docs/OPEN-QUESTIONS.md#q36)): без
  бэкоффа на `429`, без `broadcasts`; это не W14.
