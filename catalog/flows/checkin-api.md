...
- **Окно `initData` — 12 ч** (`maxAgeSeconds: 43200`, [Q49](../../docs/OPEN-QUESTIONS.md#q49)):
  `Telegram.WebApp.initData` — статичный снимок на открытие WebView, а сканер
  стоит в дверях часами; с коротким окном чекины после его истечения уходили
