...
Данные в таблицах: `strings` — **577 строк** (193 ru + 192 uz + 192 en), залиты
флоу `i18n-sync` в W3. Остальные таблицы пусты по состоянию на закрытие W1;
пробные записи W1 удалены после проверок.
