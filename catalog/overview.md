...
| Меню-хаб | [menu](flows/menu.md) — голый `/start`, любая незнакомая команда и обычный текст (W73); у организатора кнопка «Как сделать рассылку» (`menu:bcast_help`, W68); в окне викторины у гостя/контролёра первой кнопкой «Викторина» (`qz:start`, W103) |
