...
Живое состояние — 10 доменных таблиц в проекте `events-dev`, собраны в
пакете W1 ([журнал](../../docs/work/W01-tables.md)), плюс служебная
[`migrations`](migrations.md) (W31, [ADR-0021](../../docs/adr/0021-repo-is-source-of-truth-migrations-table.md)). Модель и смысл полей —
