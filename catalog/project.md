...
- **Назначение**: события, регистрация участников, QR-чекин и сегментные рассылки в Telegram
...
|-----|-----------|---------|
| dev | `vZXlkfz60dx6kX97yICx7` | текущий проект инстанса; состав — [overview.md](overview.md) |
